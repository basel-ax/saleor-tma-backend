...
```bash
INIT=$(node "/home/swenro11/projects/saleor-tma-backend/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/home/swenro11/projects/saleor-tma-backend/.claude/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
