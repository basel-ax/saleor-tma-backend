...
- Usage: Reference from command with `@/home/swenro11/projects/saleor-tma-backend/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/swenro11/projects/saleor-tma-backend/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/swenro11/projects/saleor-tma-backend/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
